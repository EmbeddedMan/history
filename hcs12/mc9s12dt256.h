/* Based on CPU DB MC9S12DT256_112, version 2.87.373 (RegistersPrg V2.23) */
/*
** ###################################################################
**     Filename  : mc9s12dt256.h
**     Processor : MC9S12DT256CPV
**     FileFormat: V2.23
**     DataSheet : 9S12DP256BDGV3/D V03.07
**     Compiler  : CodeWarrior compiler
**     Date/Time : 19.03.2008, 14:53
**     Abstract  :
...
#ifndef _MC9S12DT256_H
#define _MC9S12DT256_H
...
#define FCNFG_BKSEL_MASK                3
#define FCNFG_BKSEL_BITNUM              0
...
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** FADDRHI - Flash Address Register High; 0x00000108 ***/
    union {
      byte Byte;
      struct {
        byte FABHI0      :1;                                       /* Flash Address High Bits, bit 0 */
        byte FABHI1      :1;                                       /* Flash Address High Bits, bit 1 */
        byte FABHI2      :1;                                       /* Flash Address High Bits, bit 2 */
        byte FABHI3      :1;                                       /* Flash Address High Bits, bit 3 */
        byte FABHI4      :1;                                       /* Flash Address High Bits, bit 4 */
        byte FABHI5      :1;                                       /* Flash Address High Bits, bit 5 */
        byte FABHI6      :1;                                       /* Flash Address High Bits, bit 6 */
        byte             :1; 
      } Bits;
      struct {
        byte grpFABHI :7;
    ...
    #define FADDRHI_FABHI0              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI0
    #define FADDRHI_FABHI1              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI1
    #define FADDRHI_FABHI2              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI2
    #define FADDRHI_FABHI3              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI3
    #define FADDRHI_FABHI4              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI4
    #define FADDRHI_FABHI5              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI5
    #define FADDRHI_FABHI6              _FADDR.Overlap_STR.FADDRHISTR.Bits.FABHI6
    #define FADDRHI_FABHI               _FADDR.Overlap_STR.FADDRHISTR.MergedBits.grpFABHI
    
    #define FADDRHI_FABHI0_MASK         1
    #define FADDRHI_FABHI1_MASK         2
    #define FADDRHI_FABHI2_MASK         4
    #define FADDRHI_FABHI3_MASK         8
    #define FADDRHI_FABHI4_MASK         16
    #define FADDRHI_FABHI5_MASK         32
    #define FADDRHI_FABHI6_MASK         64
    #define FADDRHI_FABHI_MASK          127
    #define FADDRHI_FABHI_BITNUM        0
    

    /*** FADDRLO - Flash Address Register Low; 0x00000109 ***/
    union {
      byte Byte;
      struct {
        byte FABLO0      :1;                                       /* Flash Address Low Bits, bit 0 */
        byte FABLO1      :1;                                       /* Flash Address Low Bits, bit 1 */
        byte FABLO2      :1;                                       /* Flash Address Low Bits, bit 2 */
        byte FABLO3      :1;                                       /* Flash Address Low Bits, bit 3 */
        byte FABLO4      :1;                                       /* Flash Address Low Bits, bit 4 */
        byte FABLO5      :1;                                       /* Flash Address Low Bits, bit 5 */
        byte FABLO6      :1;                                       /* Flash Address Low Bits, bit 6 */
        byte FABLO7      :1;                                       /* Flash Address Low Bits, bit 7 */
      } Bits;
    } FADDRLOSTR;
    #define FADDRLO                     _FADDR.Overlap_STR.FADDRLOSTR.Byte
    #define FADDRLO_FABLO0              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO0
    #define FADDRLO_FABLO1              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO1
    #define FADDRLO_FABLO2              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO2
    #define FADDRLO_FABLO3              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO3
    #define FADDRLO_FABLO4              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO4
    #define FADDRLO_FABLO5              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO5
    #define FADDRLO_FABLO6              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO6
    #define FADDRLO_FABLO7              _FADDR.Overlap_STR.FADDRLOSTR.Bits.FABLO7
    
    #define FADDRLO_FABLO0_MASK         1
    #define FADDRLO_FABLO1_MASK         2
    #define FADDRLO_FABLO2_MASK         4
    #define FADDRLO_FABLO3_MASK         8
    #define FADDRLO_FABLO4_MASK         16
    #define FADDRLO_FABLO5_MASK         32
    #define FADDRLO_FABLO6_MASK         64
    #define FADDRLO_FABLO7_MASK         128
    
  } Overlap_STR;

  struct {
    word FABLO0      :1;                                       /* Flash Address Low Bits, bit 0 */
    word FABLO1      :1;                                       /* Flash Address Low Bits, bit 1 */
    word FABLO2      :1;                                       /* Flash Address Low Bits, bit 2 */
    word FABLO3      :1;                                       /* Flash Address Low Bits, bit 3 */
    word FABLO4      :1;                                       /* Flash Address Low Bits, bit 4 */
    word FABLO5      :1;                                       /* Flash Address Low Bits, bit 5 */
    word FABLO6      :1;                                       /* Flash Address Low Bits, bit 6 */
    word FABLO7      :1;                                       /* Flash Address Low Bits, bit 7 */
    word FABHI0      :1;                                       /* Flash Address High Bits, bit 0 */
    word FABHI1      :1;                                       /* Flash Address High Bits, bit 1 */
    word FABHI2      :1;                                       /* Flash Address High Bits, bit 2 */
    word FABHI3      :1;                                       /* Flash Address High Bits, bit 3 */
    word FABHI4      :1;                                       /* Flash Address High Bits, bit 4 */
    word FABHI5      :1;                                       /* Flash Address High Bits, bit 5 */
    word FABHI6      :1;                                       /* Flash Address High Bits, bit 6 */
    word             :1; 
  } Bits;
  struct {
    word grpFABLO :8;
...
extern volatile FADDRSTR _FADDR @(REG_BASE + 0x00000108);
#define FADDR                           _FADDR.Word
#define FADDR_FABLO0                    _FADDR.Bits.FABLO0
#define FADDR_FABLO1                    _FADDR.Bits.FABLO1
#define FADDR_FABLO2                    _FADDR.Bits.FABLO2
#define FADDR_FABLO3                    _FADDR.Bits.FABLO3
#define FADDR_FABLO4                    _FADDR.Bits.FABLO4
#define FADDR_FABLO5                    _FADDR.Bits.FABLO5
#define FADDR_FABLO6                    _FADDR.Bits.FABLO6
#define FADDR_FABLO7                    _FADDR.Bits.FABLO7
#define FADDR_FABHI0                    _FADDR.Bits.FABHI0
#define FADDR_FABHI1                    _FADDR.Bits.FABHI1
#define FADDR_FABHI2                    _FADDR.Bits.FABHI2
#define FADDR_FABHI3                    _FADDR.Bits.FABHI3
#define FADDR_FABHI4                    _FADDR.Bits.FABHI4
#define FADDR_FABHI5                    _FADDR.Bits.FABHI5
#define FADDR_FABHI6                    _FADDR.Bits.FABHI6
#define FADDR_FABLO                     _FADDR.MergedBits.grpFABLO
#define FADDR_FABHI                     _FADDR.MergedBits.grpFABHI

#define FADDR_FABLO0_MASK               1
#define FADDR_FABLO1_MASK               2
#define FADDR_FABLO2_MASK               4
#define FADDR_FABLO3_MASK               8
#define FADDR_FABLO4_MASK               16
#define FADDR_FABLO5_MASK               32
#define FADDR_FABLO6_MASK               64
#define FADDR_FABLO7_MASK               128
#define FADDR_FABHI0_MASK               256
#define FADDR_FABHI1_MASK               512
#define FADDR_FABHI2_MASK               1024
#define FADDR_FABHI3_MASK               2048
#define FADDR_FABHI4_MASK               4096
#define FADDR_FABHI5_MASK               8192
#define FADDR_FABHI6_MASK               16384
#define FADDR_FABLO_MASK                255
#define FADDR_FABLO_BITNUM              0
#define FADDR_FABHI_MASK                32512
#define FADDR_FABHI_BITNUM              8
...
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** FDATAHI - Flash Data Register High; 0x0000010A ***/
    union {
      byte Byte;
      struct {
        byte FDHI0       :1;                                       /* Flash Address High Bits, bit 0 */
        byte FDHI1       :1;                                       /* Flash Address High Bits, bit 1 */
        byte FDHI2       :1;                                       /* Flash Address High Bits, bit 2 */
        byte FDHI3       :1;                                       /* Flash Address High Bits, bit 3 */
        byte FDHI4       :1;                                       /* Flash Address High Bits, bit 4 */
        byte FDHI5       :1;                                       /* Flash Address High Bits, bit 5 */
        byte FDHI6       :1;                                       /* Flash Address High Bits, bit 6 */
        byte FDHI7       :1;                                       /* Flash Address High Bits, bit 7 */
      } Bits;
    } FDATAHISTR;
    #define FDATAHI                     _FDATA.Overlap_STR.FDATAHISTR.Byte
    #define FDATAHI_FDHI0               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI0
    #define FDATAHI_FDHI1               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI1
    #define FDATAHI_FDHI2               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI2
    #define FDATAHI_FDHI3               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI3
    #define FDATAHI_FDHI4               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI4
    #define FDATAHI_FDHI5               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI5
    #define FDATAHI_FDHI6               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI6
    #define FDATAHI_FDHI7               _FDATA.Overlap_STR.FDATAHISTR.Bits.FDHI7
    
    #define FDATAHI_FDHI0_MASK          1
    #define FDATAHI_FDHI1_MASK          2
    #define FDATAHI_FDHI2_MASK          4
    #define FDATAHI_FDHI3_MASK          8
    #define FDATAHI_FDHI4_MASK          16
    #define FDATAHI_FDHI5_MASK          32
    #define FDATAHI_FDHI6_MASK          64
    #define FDATAHI_FDHI7_MASK          128
    

    /*** FDATALO - Flash Data Register Low; 0x0000010B ***/
    union {
      byte Byte;
      struct {
        byte FDLO0       :1;                                       /* Flash Data Low Bits, bit 0 */
        byte FDLO1       :1;                                       /* Flash Data Low Bits, bit 1 */
        byte FDLO2       :1;                                       /* Flash Data Low Bits, bit 2 */
        byte FDLO3       :1;                                       /* Flash Data Low Bits, bit 3 */
        byte FDLO4       :1;                                       /* Flash Data Low Bits, bit 4 */
        byte FDLO5       :1;                                       /* Flash Data Low Bits, bit 5 */
        byte FDLO6       :1;                                       /* Flash Data Low Bits, bit 6 */
        byte FDLO7       :1;                                       /* Flash Data Low Bits, bit 7 */
      } Bits;
    } FDATALOSTR;
    #define FDATALO                     _FDATA.Overlap_STR.FDATALOSTR.Byte
    #define FDATALO_FDLO0               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO0
    #define FDATALO_FDLO1               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO1
    #define FDATALO_FDLO2               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO2
    #define FDATALO_FDLO3               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO3
    #define FDATALO_FDLO4               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO4
    #define FDATALO_FDLO5               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO5
    #define FDATALO_FDLO6               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO6
    #define FDATALO_FDLO7               _FDATA.Overlap_STR.FDATALOSTR.Bits.FDLO7
    
    #define FDATALO_FDLO0_MASK          1
    #define FDATALO_FDLO1_MASK          2
    #define FDATALO_FDLO2_MASK          4
    #define FDATALO_FDLO3_MASK          8
    #define FDATALO_FDLO4_MASK          16
    #define FDATALO_FDLO5_MASK          32
    #define FDATALO_FDLO6_MASK          64
    #define FDATALO_FDLO7_MASK          128
    
  } Overlap_STR;

  struct {
    word FDLO0       :1;                                       /* Flash Data Low Bits, bit 0 */
    word FDLO1       :1;                                       /* Flash Data Low Bits, bit 1 */
    word FDLO2       :1;                                       /* Flash Data Low Bits, bit 2 */
    word FDLO3       :1;                                       /* Flash Data Low Bits, bit 3 */
    word FDLO4       :1;                                       /* Flash Data Low Bits, bit 4 */
    word FDLO5       :1;                                       /* Flash Data Low Bits, bit 5 */
    word FDLO6       :1;                                       /* Flash Data Low Bits, bit 6 */
    word FDLO7       :1;                                       /* Flash Data Low Bits, bit 7 */
    word FDHI0       :1;                                       /* Flash Data High Bits, bit 0 */
    word FDHI1       :1;                                       /* Flash Data High Bits, bit 1 */
    word FDHI2       :1;                                       /* Flash Data High Bits, bit 2 */
    word FDHI3       :1;                                       /* Flash Data High Bits, bit 3 */
    word FDHI4       :1;                                       /* Flash Data High Bits, bit 4 */
    word FDHI5       :1;                                       /* Flash Data High Bits, bit 5 */
    word FDHI6       :1;                                       /* Flash Data High Bits, bit 6 */
    word FDHI7       :1;                                       /* Flash Data High Bits, bit 7 */
  } Bits;
  struct {
    word grpFDLO :8;
    word grpFDHI :8;
...
extern volatile FDATASTR _FDATA @(REG_BASE + 0x0000010A);
#define FDATA                           _FDATA.Word
#define FDATA_FDLO0                     _FDATA.Bits.FDLO0
#define FDATA_FDLO1                     _FDATA.Bits.FDLO1
#define FDATA_FDLO2                     _FDATA.Bits.FDLO2
#define FDATA_FDLO3                     _FDATA.Bits.FDLO3
#define FDATA_FDLO4                     _FDATA.Bits.FDLO4
#define FDATA_FDLO5                     _FDATA.Bits.FDLO5
#define FDATA_FDLO6                     _FDATA.Bits.FDLO6
#define FDATA_FDLO7                     _FDATA.Bits.FDLO7
#define FDATA_FDHI0                     _FDATA.Bits.FDHI0
#define FDATA_FDHI1                     _FDATA.Bits.FDHI1
#define FDATA_FDHI2                     _FDATA.Bits.FDHI2
#define FDATA_FDHI3                     _FDATA.Bits.FDHI3
#define FDATA_FDHI4                     _FDATA.Bits.FDHI4
#define FDATA_FDHI5                     _FDATA.Bits.FDHI5
#define FDATA_FDHI6                     _FDATA.Bits.FDHI6
#define FDATA_FDHI7                     _FDATA.Bits.FDHI7
#define FDATA_FDLO                      _FDATA.MergedBits.grpFDLO
#define FDATA_FDHI                      _FDATA.MergedBits.grpFDHI

#define FDATA_FDLO0_MASK                1
#define FDATA_FDLO1_MASK                2
#define FDATA_FDLO2_MASK                4
#define FDATA_FDLO3_MASK                8
#define FDATA_FDLO4_MASK                16
#define FDATA_FDLO5_MASK                32
#define FDATA_FDLO6_MASK                64
#define FDATA_FDLO7_MASK                128
#define FDATA_FDHI0_MASK                256
#define FDATA_FDHI1_MASK                512
#define FDATA_FDHI2_MASK                1024
#define FDATA_FDHI3_MASK                2048
#define FDATA_FDHI4_MASK                4096
#define FDATA_FDHI5_MASK                8192
#define FDATA_FDHI6_MASK                16384
#define FDATA_FDHI7_MASK                32768
#define FDATA_FDLO_MASK                 255
#define FDATA_FDLO_BITNUM               0
#define FDATA_FDHI_MASK                 65280
#define FDATA_FDHI_BITNUM               8
...
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** EADDRHI - EEPROM Address Register High; 0x00000118 ***/
    union {
      byte Byte;
      struct {
        byte EABHI0      :1;                                       /* EEPROM Address High Bits, bit 0 */
        byte EABHI1      :1;                                       /* EEPROM Address High Bits, bit 1 */
        byte EABHI2      :1;                                       /* EEPROM Address High Bits, bit 2 */
        byte             :1; 
        byte             :1; 
        byte             :1; 
        byte             :1; 
    ...
    #define EADDRHI_EABHI0              _EADDR.Overlap_STR.EADDRHISTR.Bits.EABHI0
    #define EADDRHI_EABHI1              _EADDR.Overlap_STR.EADDRHISTR.Bits.EABHI1
    #define EADDRHI_EABHI2              _EADDR.Overlap_STR.EADDRHISTR.Bits.EABHI2
    #define EADDRHI_EABHI               _EADDR.Overlap_STR.EADDRHISTR.MergedBits.grpEABHI
    
    #define EADDRHI_EABHI0_MASK         1
    #define EADDRHI_EABHI1_MASK         2
    #define EADDRHI_EABHI2_MASK         4
    #define EADDRHI_EABHI_MASK          7
    #define EADDRHI_EABHI_BITNUM        0
    

    /*** EADDRLO - EEPROM Address Register Low; 0x00000119 ***/
    union {
      byte Byte;
      struct {
        byte EABLO0      :1;                                       /* EEPROM Address Low Bits, bit 0 */
        byte EABLO1      :1;                                       /* EEPROM Address Low Bits, bit 1 */
        byte EABLO2      :1;                                       /* EEPROM Address Low Bits, bit 2 */
        byte EABLO3      :1;                                       /* EEPROM Address Low Bits, bit 3 */
        byte EABLO4      :1;                                       /* EEPROM Address Low Bits, bit 4 */
        byte EABLO5      :1;                                       /* EEPROM Address Low Bits, bit 5 */
        byte EABLO6      :1;                                       /* EEPROM Address Low Bits, bit 6 */
        byte EABLO7      :1;                                       /* EEPROM Address Low Bits, bit 7 */
      } Bits;
    } EADDRLOSTR;
    #define EADDRLO                     _EADDR.Overlap_STR.EADDRLOSTR.Byte
    #define EADDRLO_EABLO0              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO0
    #define EADDRLO_EABLO1              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO1
    #define EADDRLO_EABLO2              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO2
    #define EADDRLO_EABLO3              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO3
    #define EADDRLO_EABLO4              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO4
    #define EADDRLO_EABLO5              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO5
    #define EADDRLO_EABLO6              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO6
    #define EADDRLO_EABLO7              _EADDR.Overlap_STR.EADDRLOSTR.Bits.EABLO7
    
    #define EADDRLO_EABLO0_MASK         1
    #define EADDRLO_EABLO1_MASK         2
    #define EADDRLO_EABLO2_MASK         4
    #define EADDRLO_EABLO3_MASK         8
    #define EADDRLO_EABLO4_MASK         16
    #define EADDRLO_EABLO5_MASK         32
    #define EADDRLO_EABLO6_MASK         64
    #define EADDRLO_EABLO7_MASK         128
    
  } Overlap_STR;

  struct {
    word EABLO0      :1;                                       /* EEPROM Address Low Bits, bit 0 */
    word EABLO1      :1;                                       /* EEPROM Address Low Bits, bit 1 */
    word EABLO2      :1;                                       /* EEPROM Address Low Bits, bit 2 */
    word EABLO3      :1;                                       /* EEPROM Address Low Bits, bit 3 */
    word EABLO4      :1;                                       /* EEPROM Address Low Bits, bit 4 */
    word EABLO5      :1;                                       /* EEPROM Address Low Bits, bit 5 */
    word EABLO6      :1;                                       /* EEPROM Address Low Bits, bit 6 */
    word EABLO7      :1;                                       /* EEPROM Address Low Bits, bit 7 */
    word EABHI0      :1;                                       /* EEPROM Address High Bits, bit 0 */
    word EABHI1      :1;                                       /* EEPROM Address High Bits, bit 1 */
    word EABHI2      :1;                                       /* EEPROM Address High Bits, bit 2 */
    word             :1; 
    word             :1; 
    word             :1; 
    word             :1; 
...
extern volatile EADDRSTR _EADDR @(REG_BASE + 0x00000118);
#define EADDR                           _EADDR.Word
#define EADDR_EABLO0                    _EADDR.Bits.EABLO0
#define EADDR_EABLO1                    _EADDR.Bits.EABLO1
#define EADDR_EABLO2                    _EADDR.Bits.EABLO2
#define EADDR_EABLO3                    _EADDR.Bits.EABLO3
#define EADDR_EABLO4                    _EADDR.Bits.EABLO4
#define EADDR_EABLO5                    _EADDR.Bits.EABLO5
#define EADDR_EABLO6                    _EADDR.Bits.EABLO6
#define EADDR_EABLO7                    _EADDR.Bits.EABLO7
#define EADDR_EABHI0                    _EADDR.Bits.EABHI0
#define EADDR_EABHI1                    _EADDR.Bits.EABHI1
#define EADDR_EABHI2                    _EADDR.Bits.EABHI2
#define EADDR_EABLO                     _EADDR.MergedBits.grpEABLO
#define EADDR_EABHI                     _EADDR.MergedBits.grpEABHI

#define EADDR_EABLO0_MASK               1
#define EADDR_EABLO1_MASK               2
#define EADDR_EABLO2_MASK               4
#define EADDR_EABLO3_MASK               8
#define EADDR_EABLO4_MASK               16
#define EADDR_EABLO5_MASK               32
#define EADDR_EABLO6_MASK               64
#define EADDR_EABLO7_MASK               128
#define EADDR_EABHI0_MASK               256
#define EADDR_EABHI1_MASK               512
#define EADDR_EABHI2_MASK               1024
#define EADDR_EABLO_MASK                255
#define EADDR_EABLO_BITNUM              0
#define EADDR_EABHI_MASK                1792
#define EADDR_EABHI_BITNUM              8
...
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** EDATAHI - EEPROM Data Register High; 0x0000011A ***/
    union {
      byte Byte;
      struct {
        byte EDHI0       :1;                                       /* EEPROM Address High Bits, bit 0 */
        byte EDHI1       :1;                                       /* EEPROM Address High Bits, bit 1 */
        byte EDHI2       :1;                                       /* EEPROM Address High Bits, bit 2 */
        byte EDHI3       :1;                                       /* EEPROM Address High Bits, bit 3 */
        byte EDHI4       :1;                                       /* EEPROM Address High Bits, bit 4 */
        byte EDHI5       :1;                                       /* EEPROM Address High Bits, bit 5 */
        byte EDHI6       :1;                                       /* EEPROM Address High Bits, bit 6 */
        byte EDHI7       :1;                                       /* EEPROM Address High Bits, bit 7 */
      } Bits;
    } EDATAHISTR;
    #define EDATAHI                     _EDATA.Overlap_STR.EDATAHISTR.Byte
    #define EDATAHI_EDHI0               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI0
    #define EDATAHI_EDHI1               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI1
    #define EDATAHI_EDHI2               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI2
    #define EDATAHI_EDHI3               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI3
    #define EDATAHI_EDHI4               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI4
    #define EDATAHI_EDHI5               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI5
    #define EDATAHI_EDHI6               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI6
    #define EDATAHI_EDHI7               _EDATA.Overlap_STR.EDATAHISTR.Bits.EDHI7
    
    #define EDATAHI_EDHI0_MASK          1
    #define EDATAHI_EDHI1_MASK          2
    #define EDATAHI_EDHI2_MASK          4
    #define EDATAHI_EDHI3_MASK          8
    #define EDATAHI_EDHI4_MASK          16
    #define EDATAHI_EDHI5_MASK          32
    #define EDATAHI_EDHI6_MASK          64
    #define EDATAHI_EDHI7_MASK          128
    

    /*** EDATALO - EEPROM Data Register Low; 0x0000011B ***/
    union {
      byte Byte;
      struct {
        byte EDLO0       :1;                                       /* EEPROM Data Low Bits, bit 0 */
        byte EDLO1       :1;                                       /* EEPROM Data Low Bits, bit 1 */
        byte EDLO2       :1;                                       /* EEPROM Data Low Bits, bit 2 */
        byte EDLO3       :1;                                       /* EEPROM Data Low Bits, bit 3 */
        byte EDLO4       :1;                                       /* EEPROM Data Low Bits, bit 4 */
        byte EDLO5       :1;                                       /* EEPROM Data Low Bits, bit 5 */
        byte EDLO6       :1;                                       /* EEPROM Data Low Bits, bit 6 */
        byte EDLO7       :1;                                       /* EEPROM Data Low Bits, bit 7 */
      } Bits;
    } EDATALOSTR;
    #define EDATALO                     _EDATA.Overlap_STR.EDATALOSTR.Byte
    #define EDATALO_EDLO0               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO0
    #define EDATALO_EDLO1               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO1
    #define EDATALO_EDLO2               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO2
    #define EDATALO_EDLO3               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO3
    #define EDATALO_EDLO4               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO4
    #define EDATALO_EDLO5               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO5
    #define EDATALO_EDLO6               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO6
    #define EDATALO_EDLO7               _EDATA.Overlap_STR.EDATALOSTR.Bits.EDLO7
    
    #define EDATALO_EDLO0_MASK          1
    #define EDATALO_EDLO1_MASK          2
    #define EDATALO_EDLO2_MASK          4
    #define EDATALO_EDLO3_MASK          8
    #define EDATALO_EDLO4_MASK          16
    #define EDATALO_EDLO5_MASK          32
    #define EDATALO_EDLO6_MASK          64
    #define EDATALO_EDLO7_MASK          128
    
  } Overlap_STR;

  struct {
    word EDLO0       :1;                                       /* EEPROM Data Low Bits, bit 0 */
    word EDLO1       :1;                                       /* EEPROM Data Low Bits, bit 1 */
    word EDLO2       :1;                                       /* EEPROM Data Low Bits, bit 2 */
    word EDLO3       :1;                                       /* EEPROM Data Low Bits, bit 3 */
    word EDLO4       :1;                                       /* EEPROM Data Low Bits, bit 4 */
    word EDLO5       :1;                                       /* EEPROM Data Low Bits, bit 5 */
    word EDLO6       :1;                                       /* EEPROM Data Low Bits, bit 6 */
    word EDLO7       :1;                                       /* EEPROM Data Low Bits, bit 7 */
    word EDHI0       :1;                                       /* EEPROM Data High Bits, bit 0 */
    word EDHI1       :1;                                       /* EEPROM Data High Bits, bit 1 */
    word EDHI2       :1;                                       /* EEPROM Data High Bits, bit 2 */
    word EDHI3       :1;                                       /* EEPROM Data High Bits, bit 3 */
    word EDHI4       :1;                                       /* EEPROM Data High Bits, bit 4 */
    word EDHI5       :1;                                       /* EEPROM Data High Bits, bit 5 */
    word EDHI6       :1;                                       /* EEPROM Data High Bits, bit 6 */
    word EDHI7       :1;                                       /* EEPROM Data High Bits, bit 7 */
  } Bits;
  struct {
    word grpEDLO :8;
    word grpEDHI :8;
...
extern volatile EDATASTR _EDATA @(REG_BASE + 0x0000011A);
#define EDATA                           _EDATA.Word
#define EDATA_EDLO0                     _EDATA.Bits.EDLO0
#define EDATA_EDLO1                     _EDATA.Bits.EDLO1
#define EDATA_EDLO2                     _EDATA.Bits.EDLO2
#define EDATA_EDLO3                     _EDATA.Bits.EDLO3
#define EDATA_EDLO4                     _EDATA.Bits.EDLO4
#define EDATA_EDLO5                     _EDATA.Bits.EDLO5
#define EDATA_EDLO6                     _EDATA.Bits.EDLO6
#define EDATA_EDLO7                     _EDATA.Bits.EDLO7
#define EDATA_EDHI0                     _EDATA.Bits.EDHI0
#define EDATA_EDHI1                     _EDATA.Bits.EDHI1
#define EDATA_EDHI2                     _EDATA.Bits.EDHI2
#define EDATA_EDHI3                     _EDATA.Bits.EDHI3
#define EDATA_EDHI4                     _EDATA.Bits.EDHI4
#define EDATA_EDHI5                     _EDATA.Bits.EDHI5
#define EDATA_EDHI6                     _EDATA.Bits.EDHI6
#define EDATA_EDHI7                     _EDATA.Bits.EDHI7
#define EDATA_EDLO                      _EDATA.MergedBits.grpEDLO
#define EDATA_EDHI                      _EDATA.MergedBits.grpEDHI

#define EDATA_EDLO0_MASK                1
#define EDATA_EDLO1_MASK                2
#define EDATA_EDLO2_MASK                4
#define EDATA_EDLO3_MASK                8
#define EDATA_EDLO4_MASK                16
#define EDATA_EDLO5_MASK                32
#define EDATA_EDLO6_MASK                64
#define EDATA_EDLO7_MASK                128
#define EDATA_EDHI0_MASK                256
#define EDATA_EDHI1_MASK                512
#define EDATA_EDHI2_MASK                1024
#define EDATA_EDHI3_MASK                2048
#define EDATA_EDHI4_MASK                4096
#define EDATA_EDHI5_MASK                8192
#define EDATA_EDHI6_MASK                16384
#define EDATA_EDHI7_MASK                32768
#define EDATA_EDLO_MASK                 255
#define EDATA_EDLO_BITNUM               0
#define EDATA_EDHI_MASK                 65280
#define EDATA_EDHI_BITNUM               8
...
#define NVFPROT3_FPLS0_MASK             1
#define NVFPROT3_FPLS1_MASK             2
#define NVFPROT3_FPLDIS_MASK            4
#define NVFPROT3_FPHS0_MASK             8
#define NVFPROT3_FPHS1_MASK             16
#define NVFPROT3_FPHDIS_MASK            32
#define NVFPROT3_NV6_MASK               64
#define NVFPROT3_FPOPEN_MASK            128
#define NVFPROT3_FPLS_MASK              3
#define NVFPROT3_FPLS_BITNUM            0
#define NVFPROT3_FPHS_MASK              24
#define NVFPROT3_FPHS_BITNUM            3
...
#define NVFPROT2_FPLS0_MASK             1
#define NVFPROT2_FPLS1_MASK             2
#define NVFPROT2_FPLDIS_MASK            4
#define NVFPROT2_FPHS0_MASK             8
#define NVFPROT2_FPHS1_MASK             16
#define NVFPROT2_FPHDIS_MASK            32
#define NVFPROT2_NV6_MASK               64
#define NVFPROT2_FPOPEN_MASK            128
#define NVFPROT2_FPLS_MASK              3
#define NVFPROT2_FPLS_BITNUM            0
#define NVFPROT2_FPHS_MASK              24
#define NVFPROT2_FPHS_BITNUM            3
