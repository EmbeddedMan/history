...
#define FLASH_CATALOG_PAGE   (byte *)(START_DYNAMIC+2*BASIC_LARGE_PAGE_SIZE)
#define FLASH_PARAM1_PAGE    (byte *)(START_DYNAMIC+2*BASIC_LARGE_PAGE_SIZE+BASIC_SMALL_PAGE_SIZE)
#define FLASH_PARAM2_PAGE    (byte *)(START_DYNAMIC+2*BASIC_LARGE_PAGE_SIZE+2*BASIC_SMALL_PAGE_SIZE)
// N.B. we leave the final page alone for interrupt vectors
#define FLASH_STORE_PAGE(x)  (byte *)(FLASH2_START+((x)*BASIC_LARGE_PAGE_SIZE))
#else
