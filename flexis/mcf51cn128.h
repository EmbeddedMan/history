...
typedef union {
  ...
  struct {
    ...
    byte PTHIFE5     :1;                                       /* Port A Input Filter Enable Bit 5 */
    byte PTHIFE6     :1;                                       /* Port A Input Filter Enable Bit 6 */
    byte PTHIFE7     :1;                                       /* Port A Input Filter Enable Bit 7 */
  } Bits;
} PTHIFESTR;
...
typedef union {
  ...
  struct {
    ...
    byte PTJIFE5     :1;                                       /* Port A Input Filter Enable Bit 5 */
    byte             :1; 
    byte             :1; 
  } Bits;
  struct {
...
typedef union {
  ...
  struct {
    ...
    dword            :1; 
    dword            :1; 
    dword RDAR_bit   :1;                                       /* Set to one when this register is written, regardless of the value written. Cleared by the FEC device whenever no additional &quot;empty&quot; descriptors remain in the receive ring. Also cleared when ECR[ETHER_EN] is cleared */ /*Warning: group name is duplicated with register name*/
    dword            :1; 
    dword            :1; 
    dword            :1; 
    dword            :1; 
...
typedef union {
  ...
  struct {
    ...
    dword            :1; 
    dword            :1; 
    dword TDAR_bit   :1;                                       /* Set to one when this register is written, regardless of the value written. Cleared by the FEC device whenever no additional ready descriptors remain in the transmit ring. Also cleared when ECR[ETHER_EN] is cleared */ /*Warning: group name is duplicated with register name*/
    dword            :1; 
    dword            :1; 
    dword            :1; 
    dword            :1; 
...
#define PAUR_PADDR2_10                  _PAUR.MergedBits.grpPADDR2_10
#define PAUR_PADDR                      PAUR_PADDR2
...
#define PAUR_PADDR2_MASK                67043328
#define PAUR_PADDR2_BITNUM              16
#define PAUR_PADDR2_10_MASK             4227858432
#define PAUR_PADDR2_10_BITNUM           26
...
typedef union {
  ...
  struct {
    ...
    dword WS0        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 0 */
    dword WS1        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 1 */
    dword WS2        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 2 */
    dword WS3        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 3 */
    dword WS4        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 4 */
    dword WS5        :1;                                       /* Wait states. The number of wait states inserted before an internal transfer acknowledge is generated (WS = 0 inserts zero wait states, WS = 0xF inserts 15 wait states). If AA = 0, TA must be asserted by the external system regardless of the number of wait states generated. In that case, the external transfer acknowledge ends the cycle. An external TA supercedes the generation of an internal TA, bit 5 */
...
typedef union {
  ...
  struct {
    ...
    byte             :1; 
    byte             :1; 
    byte SCI3DO      :1;                                       /* Disable (mask) SCI3_OR interrupt request */
    byte             :1; 
    byte FECDO       :1;                                       /* Disable (mask) FEC_Other interrupt request */
  } Bits;
} INTC_ORMRSTR;
extern volatile INTC_ORMRSTR _INTC_ORMR @0xFFFFFFCD;
#define INTC_ORMR                       _INTC_ORMR.Byte
...
#define INTC_ORMR_FECDO_MASK            128
